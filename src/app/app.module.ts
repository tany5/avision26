...
import { ThankyouliveclassComponent } from './pages/thankyouliveclass/thankyouliveclass.component';
import { PassSuccessComponent } from './pages/pass-success/pass-success.component';
...
@NgModule({
  declarations: [
    ...
    AtseComponent,
    AtseThanksComponent,
    ThankyouliveclassComponent,
    PassSuccessComponent
  ...
  entryComponents: [MessageDialougeComponent,HomepopupComponent,PlanpopupComponent,SchollarComponent,ScholarregisterComponent,AtseComponent,AtseThanksComponent,ThankyouliveclassComponent,PassSuccessComponent]
